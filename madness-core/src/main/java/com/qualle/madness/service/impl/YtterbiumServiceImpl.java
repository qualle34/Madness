...
public class YtterbiumServiceImpl implements ElementService {

    private final WikipediaRestClient wikipediaClient;

    public YtterbiumServiceImpl(WikipediaRestClient wikipediaClient) {
        this.wikipediaClient = wikipediaClient;
    }

    @Override
    public int getAtomicNumber() {
        return wikipediaClient.getYtterbiumAtomicNumber();
    }
}